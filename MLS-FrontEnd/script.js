...
const logo = document.getElementById('logo'); // May be null on some pages

// Update logo based on theme (only if logo exists)
function updateLogo(theme) {
  if (logo) {
    if (theme === 'dark') {
      logo.src = 'assets/MLS Logo Dark.png'; // Light logo for dark mode
    } else {
      logo.src = 'assets/MLS Logo.png'; // Dark logo for light mode
    }
  }
}
